...
import com.example.baatcheet.Adapters.MessagesAdapter;
...
public class chatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        database.getReference().child("present").child(receiverUid).addValueEventListener(new ValueEventListener() {
            @Override
        ...
        binding.sendBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String messageTxt = binding.mssgBox.getText().toString();
                Date date = new Date();
        ...
        binding.mssgBox.addTextChangedListener(new TextWatcher() {
            @Override
            ...
            public void afterTextChanged(Editable s) {
                database.getReference().child("present").child(senderUid).setValue("typing...");
            ...
            Runnable userStoppedTyping = new Runnable() {
                @Override
                public void run() {
                    database.getReference().child("present").child(senderUid).setValue("Online");
